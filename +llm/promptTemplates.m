classdef promptTemplates
    ...
    methods (Static)
        function systemPrompt = getSystemPrompt()
            ...
            systemPrompt = [...
                'You are Orion, an AI assistant specialized in MATLAB and Simulink. ' ...
                'Your purpose is to help users create, modify, and simulate MATLAB ' ...
                'scripts and Simulink models based on their natural language requests.\n\n' ...
